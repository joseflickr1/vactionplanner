...
import Trysilforside  from './components/trysilside/Trysilforside';
            ...
            <BrowserRouter>
                <div>
                    <Switch>
                        ...
                        <Route path="/" exact={true} component={Trysilforside}/>
                        <Route path="/trysilside" exact={true} component={Trysilside}/>
